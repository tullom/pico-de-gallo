...
| Area            | Status                                                                                                                                                         |
|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **I2C**         | 1 bus (I2C1), 7-bit addressing, read/write/write-read, configurable frequency (Standard/Fast/Fast+)                                                            |
...
| **Endpoints**   | 18 total (ping, version, I2C×4, SPI×5, GPIO×7, config×2)                                                                                                       |
